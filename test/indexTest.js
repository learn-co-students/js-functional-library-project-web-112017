...
describe('index.js', function () {
  ...
  describe('uniq', function () {
    ...
    // if hashsets are used it is O(n) for either one (see js's built in Set).
    // a better test would be to check if they are bruteforcing it and running in O(n^2) time as a function of calls made
